/*  ханойская башня нерекурсия
 мой комментарий
 опытным путем: 2 палки, между которыми происходит обмен, повторяются каждых 3 раза:
 12  13  23  12  13  23  12  13  23 ...
 только с какой на какую зависит от того, есть ли элемент на одной из 2-х палок,
 а если оба есть - то выбираем который из них больше и на него кладем меньший
 */
